CREATE DATABASE ASSIGNMENT2_PHAMNGOCDANG
...
INSERT INTO SACH(MASACH,TENSACH,NHASANXUAT,MATACGIA,SOLUONGBANSAO,GIATIEN,NGAYNHAPKHO,VITRI,SOTRANG) VALUES
('MS22',N'CHÚ CỪU',N'VIỆT NAM','LT','1',12000000,'2022/08/12',N'BẮC GIANG',2),
('MS23',N'CON VỊT',N'QUỐC VIỆT','TD','2',15000000,'2023/10/12',N'HÀ NỘI',10),
('MS24',N'CÂY TRE',N'TRUNG QUỐC','KG','8',19000000,'2010/12/22',N'THÁI NGUYÊN',30),
('MS25',N'THIẾU NỮ',N'CỦ CHI','XH','20',100000,'2019/09/10',N'HIỆP HOÀ',92);
SELECT * FROM SACH
DELETE FROM SACH

-- 6.1 Liệt kê tất cả thông tin của các đầu sách gồm tên sách, mã sách, giá tiền , tác giả
-- thuộc loại sách có vị trí “Bắc Giang”.
SELECT TENSACH, MASACH, GIATIEN, MATACGIA FROM SACH WHERE VITRI = N'Bắc Giang';
SELECT * FROM SACH
...
-- 6.5 Hiển thị tất cả các quyển sách có tiêu đề chứa từ khoá “SQL”.
SELECT * FROM SACH WHERE TENSACH LIKE N'%CHÚ CỪU%';

-- 6.6 Viết câu lệnh cập nhật lại giá tiền của các quyển sách có ngày nhập kho trước năm
-- 2014 giảm 30%.
UPDATE SACH
...
-- 6.7 Viết câu lệnh cập nhật lại trạng thái đã trả sách cho phiếu mượn của sinh viên có mã
-- sinh viên PD12301 (ví dụ).
UPDATE PHIEUMUON 
...
-- 6.8 Viết câu lệnh cập nhật lại số lượng bản sao tăng lên 5 đơn vị đối với các đầu sách có
...
-- 6.9 Viết câu lệnh xoá các phiếu mượn có ngày mượn và ngày trả trước „1/1/2010‟
DELETE FROM CHITIET_PHIEUDON
