...
public class Main {
    ...
    public static void main(String[] args) {
        Integer choice;
        QuanLiChuyenNganh chucNang = new QuanLiChuyenNganh();
        do{
            System.out.println("-------------------------------------");
            ...
            System.out.println("4.Sap xep danh sach chuyen nganh theo so giang vien");
            System.out.println("5.Xoa chuyen nganh theo ma");
