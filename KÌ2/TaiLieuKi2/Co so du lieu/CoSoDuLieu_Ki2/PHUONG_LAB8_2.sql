...
('T02', N'TIÊN', N'GAM', 140000, N'?AU B?NG'),
('T03', N'TI?N', N'GAM', 30000, N'NGHÈO');
...
('HS02', N'TH?T LÀ ??P', '2002/01/12', N'NAM', '00D20041630', '2009/04/21'),
('HS03', N'NGUY?N THU TH?Y', '1997/03/22', N'N?', 'N0932311630', '2009/09/03');

INSERT INTO KHAMBENH(MAKB,MAHS, NGAYKHAM, BACSI, KETLUAN) VALUES 
('KB01', 'HS01', '2012/02/18', N'KHÔNG BI?T AI', N'?N'),
('KB02', 'HS02', '2014/04/22', N'XUÂN THU TH?Y', N'UNG TH?'),
...
WHERE NHOMDIEUCHI LIKE N'NGHÈO'
--11
